...
error_reporting(0);
			...
			// Search Analytics
				...
				require_once(VQMod::modCheck(DIR_SYSTEM . 'library/search_analytics.php'));
            ...
            // Advanced Smart Search
                ...
                require_once(VQMod::modCheck(DIR_SYSTEM . 'library/inflect.php'));
...
require_once(VQMod::modCheck(DIR_SYSTEM . 'library/emailtemplate/email_template.php'));
?>