...
$this->data['text_purchasevoucher'] = $this->language->get('text_purchasevoucher');
...
$this->data['purchasevoucher'] = $this->url->link('sale/purchasevoucher', 'token=' . $this->session->data['token'], 'SSL');
