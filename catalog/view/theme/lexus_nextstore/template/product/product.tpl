...
<?php
 ...
 ?>
			...
			<a class="sharesocial">SHARE: &nbsp;</a> 
				...
				<a onclick="PopupCenter('https://plus.google.com/share?url=gofootlounge.in','xtf','450','400');"><img class="piconcls" src="gofootlounge.in/image/social-icons/google_plus27.png"></a>&nbsp;&nbsp;<a onclick="PopupCenter('https://twitter.com/intent/tweet?text=@go_footlounge&','xtf','450','400');"><img class="piconcls" src="gofootlounge.in/image/social-icons/twittersmall1.png"></a>&nbsp; 
				<a onclick="PopupCenter('http://www.facebook.com/sharer/sharer.php?u=gofootlounge.in','xtf','450','400');"> <img class="piconcls" src="gofootlounge.in/image/icon-facebook.png"></a>
...
<div class="modal fade" tabindex="-1" role="dialog" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!--<div style="margin-bottom: 20px;" ><p>This product has been solded out! Kindly fill the following details, our executive will contact you in another 48 hours. <a href="gofootlounge.in/new-arrivals"><span style="color: #CD6927 " id="modal_content">Happy Shopping</span><a></p></div>-->
      ...
      <span class="alert alert-danger new_asearch_padd1" id="failure_msg">sending failed</span>
      	<img src="gofootlounge.in/image/loading_spinner.gif" alt="loading..." id="image_spinner">
