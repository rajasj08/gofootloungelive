...
<?php
 ...
 ?>
			...
			<a class="sharesocial">SHARE: &nbsp;</a> 
				...
				<a onclick="PopupCenter('https://plus.google.com/share?url=http://www.footlounge.in','xtf','450','400');"><img class="piconcls" src="http://www.footlounge.in/image/social-icons/google_plus27.png"></a>&nbsp;&nbsp;<a onclick="PopupCenter('https://twitter.com/intent/tweet?text=@go_footlounge&','xtf','450','400');"><img class="piconcls" src="http://www.footlounge.in/image/social-icons/twittersmall1.png"></a>&nbsp; 
				<a onclick="PopupCenter('http://www.facebook.com/sharer/sharer.php?u=http://www.footlounge.in','xtf','450','400');"> <img class="piconcls" src="http://www.footlounge.in/image/icon-facebook.png"></a>
