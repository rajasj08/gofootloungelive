		...
		<div class="container">
			...
			<div class="col-md-4 col-sm-12">
				<div class="shipping-cod-secure-payment-cont">
					<img src="http://new-env.ap-south-1.elasticbeanstalk.com/image/shipping-cod-secure-payment.png">
				</div>
...
<img src="http://new-env.ap-south-1.elasticbeanstalk.com/image/indian-rupee-symbol-icon.png" alt="cash on delivery">cash on delivery
</div>
<div class="col-sm-4">

<img src="http://new-env.ap-south-1.elasticbeanstalk.com/image/100-percent-secure-icon.png" alt="secure shopping">Secure Shopping
</div>
<div class="col-sm-4">
<img src="http://new-env.ap-south-1.elasticbeanstalk.com/image/free-shipping-icon.png" alt="free shipping">free shipping	
</div>
<div class="clear"></div>
</div>
<div class="clear"></div>
				...
				<div class="box customer-service">
					...
					<div class="box-content">
						<ul class="list">						  
							...
							<li><a href="http://new-env.ap-south-1.elasticbeanstalk.com/Footlounge-Frequently-Asked-Questions">FAQ</a></li>
						</ul>
					</div>	
				</div>
			</div>
...
<img src="http://new-env.ap-south-1.elasticbeanstalk.com/image/downarrow.png" alt="footlounge">
...
<div class="footernstyle">Introducing Brand <img src="http://new-env.ap-south-1.elasticbeanstalk.com/image/data/lo2logo.png" alt="Footlounge Logo" class="footerlogoimg"/></div>
...
<div class="mobilelastcol"><a href="http://new-env.ap-south-1.elasticbeanstalk.com/terms-conditions">Terms &amp; Conditions</a> | <a href="http://new-env.ap-south-1.elasticbeanstalk.com/privacy-policy-and-pisclaimer">Privacy Policy</a> | <a href="http://new-env.ap-south-1.elasticbeanstalk.com/aboutus">About Us</a></div></div>
</div>	
