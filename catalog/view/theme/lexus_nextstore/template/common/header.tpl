					...
					<div class="toppart">
						...
						<div class="toppartright">
							...
							<div class="socialicons">
								...
								<div class="social-icon1"><a target="_blank" href="   https://in.pinterest.com/footloungeindia/"><img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/social-icons/pinterest_27.png"></a></div>

								<div class="social-icon1"><a target="_blank" href=" https://plus.google.com/115256944391879546136/posts"><img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/social-icons/google_plus27.png"></a></div>

								<div class="social-icon1"><a target="_blank" href="https://www.youtube.com/c/adidas"><img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/social-icons/youtube-iconsmall.png" alt="Foot Lounge YouTube"></a></div>  
								
								<div class="social-icon1"><a target="_blank" href="https://www.instagram.com/go_footlounge"><img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/social-icons/instagramsmall.png" alt="Foot Lounge Instagram"></a></div>
								 
								<div class="social-icon1"><a target="_blank" href="https://twitter.com/go_footlounge"><img src="http://gofootlounge-env.ap-south-1.elasticbeanstalk.com/image/social-icons/twittersmall1.png" alt="Foot LoungeTwitter"></a></div>	
