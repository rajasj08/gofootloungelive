...
<section id="content404" class="content404">
    ...
    <div tabindex="501" class="screenreader">
       <img src="http://new-env.ap-south-1.elasticbeanstalk.com/catalog/view/theme/lexus_nextstore/image/FootLounge-Page410-Error.jpg" class="new_page_imgwid" alt="Page 404">
