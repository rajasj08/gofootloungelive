...
<section id="content404" class="content404">
    ...
    <div tabindex="501" class="screenreader">
       <img src="http://www.footlounge.in/catalog/view/theme/lexus_nextstore/image/page404/teamflcartoonshoes.png" class="new_page_imgwid" alt="Page 404">
							...
							<div class="inner">
								<ul>
									...
									<!---<li class="col-lg-12 col-sm-12 col-xs-12">
										<a href="http://www.footlounge.in/running-shoes">Top Brands</a>
										...
										<ul> -->
											...
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="http://www.footlounge.in/men">Men</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/women">Women</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/kids">Kids</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/fitness">Fitness</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/apparel">Apparel</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/flip-flops">Flip Flops</a>
																							
											</li>

											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/lifestyle-sandals">LifeStyle Sandals</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="http://www.footlounge.in/luggage-bags">Luggage Bags</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="http://www.footlounge.in/running-shoes">Running Shoes</a>
								...
								<ul>
									...
									<!---<li class="col-lg-12 col-sm-12 col-xs-12">
										...
										<ul> -->
											...
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="http://www.footlounge.in/adidas-shoes-online">Adidas</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/reebok-shoes-online">Reebok</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/nike-shoes-online">Nike</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/american-tourister-travel-bags-online">American Tourister</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/fila-shoes-online">Fila</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/footlounge-sports-clothing-online">Foot Lounge</a>
																							
											</li>

											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/lee-cooper-shoes-online">Lee Cooper</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="http://www.footlounge.in/puma-shoes-online">Puma</a>
		...
		<div class="row brandrow">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
							<div class="inner">
								...
								<!---	<li class="col-lg-12 col-sm-12 col-xs-12">
										<a href="http://www.footlounge.in/running-shoes">Information</a>
									
										<ul> -->
											
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="http://www.footlounge.in/about_us">About Us</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/delivery-information">Delivery Information</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/terms-conditions">Terms &amp; Conditions</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/privacy-policy-and-pisclaimer">Privacy Policy And Disclaimer</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="http://www.footlounge.in/footlounge-return-policy">Return Policy</a>
							...
							<div class="inner">
								...
								<!---	<li class="col-lg-12 col-sm-12 col-xs-12">
										...
										<ul> -->
											...
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="http://www.footlounge.in/contact">Contact Us</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/return">Returns</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://www.footlounge.in/sitemap">Site Map</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="http://www.footlounge.in/Footlounge-Frequently-Asked-Questions">FAQ</a>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <span id="loadingspan" class="new_page_disp1"><img src="http://www.footlounge.in/catalog/view/theme/lexus_nextstore/image/fb-loading.gif" alt="Loading"> </span>  
