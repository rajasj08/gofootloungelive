...
<section id="content404" class="content404">
    ...
    <div tabindex="501" class="screenreader">
       <img src="gofootlounge.in/catalog/view/theme/lexus_nextstore/image/page404/teamflcartoonshoes.png" class="new_page_imgwid" alt="Page 404">
							...
							<div class="inner">
								<ul>
									...
									<!---<li class="col-lg-12 col-sm-12 col-xs-12">
										<a href="gofootlounge.in/running-shoes">Top Brands</a>
										...
										<ul> -->
											...
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="gofootlounge.in/men">Men</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/women">Women</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/kids">Kids</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/fitness">Fitness</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/apparel">Apparel</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/flip-flops">Flip Flops</a>
																							
											</li>

											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/lifestyle-sandals">LifeStyle Sandals</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="gofootlounge.in/luggage-bags">Luggage Bags</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="gofootlounge.in/running-shoes">Running Shoes</a>
								...
								<ul>
									...
									<!---<li class="col-lg-12 col-sm-12 col-xs-12">
										...
										<ul> -->
											...
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="gofootlounge.in/adidas-shoes-online">Adidas</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/reebok-shoes-online">Reebok</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/nike-shoes-online">Nike</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/american-tourister-travel-bags-online">American Tourister</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/fila-shoes-online">Fila</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/footlounge-sports-clothing-online">Foot Lounge</a>
																							
											</li>

											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/lee-cooper-shoes-online">Lee Cooper</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="gofootlounge.in/puma-shoes-online">Puma</a>
		...
		<div class="row brandrow">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
							<div class="inner">
								...
								<!---	<li class="col-lg-12 col-sm-12 col-xs-12">
										<a href="gofootlounge.in/running-shoes">Information</a>
									
										<ul> -->
											
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="gofootlounge.in/about_us">About Us</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/delivery-information">Delivery Information</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/terms-conditions">Terms &amp; Conditions</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/privacy-policy-and-pisclaimer">Privacy Policy And Disclaimer</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="gofootlounge.in/footlounge-return-policy">Return Policy</a>
							...
							<div class="inner">
								...
								<!---	<li class="col-lg-12 col-sm-12 col-xs-12">
										...
										<ul> -->
											...
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="gofootlounge.in/contact">Contact Us</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/return">Returns</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="gofootlounge.in/sitemap">Site Map</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="gofootlounge.in/Footlounge-Frequently-Asked-Questions">FAQ</a>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <span id="loadingspan" class="new_page_disp1"><img src="gofootlounge.in/catalog/view/theme/lexus_nextstore/image/fb-loading.gif" alt="Loading"> </span>  
