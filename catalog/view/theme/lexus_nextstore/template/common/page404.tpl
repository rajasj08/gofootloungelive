...
<section id="content404" class="content404">
    ...
    <div tabindex="501" class="screenreader">
       <img src="http://new-env.ap-south-1.elasticbeanstalk.com/catalog/view/theme/lexus_nextstore/image/page404/teamflcartoonshoes.png" class="new_page_imgwid" alt="Page 404">
							...
							<div class="inner">
								<ul>
									...
									<!---<li class="col-lg-12 col-sm-12 col-xs-12">
										<a href="http://new-env.ap-south-1.elasticbeanstalk.com/running-shoes">Top Brands</a>
										...
										<ul> -->
											...
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="http://new-env.ap-south-1.elasticbeanstalk.com/men">Men</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://new-env.ap-south-1.elasticbeanstalk.com/women">Women</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://new-env.ap-south-1.elasticbeanstalk.com/kids">Kids</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://new-env.ap-south-1.elasticbeanstalk.com/fitness">Fitness</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://new-env.ap-south-1.elasticbeanstalk.com/apparel">Apparel</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://new-env.ap-south-1.elasticbeanstalk.com/flip-flops">Flip Flops</a>
																							
											</li>

											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="http://new-env.ap-south-1.elasticbeanstalk.com/lifestyle-sandals">LifeStyle Sandals</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="http://new-env.ap-south-1.elasticbeanstalk.com/luggage-bags">Luggage Bags</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="http://new-env.ap-south-1.elasticbeanstalk.com/running-shoes">Running Shoes</a>
		...
		<div class="row brandrow">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
							<div class="inner">
								...
								<!---	<li class="col-lg-12 col-sm-12 col-xs-12">
										<a href="http://new-env.ap-south-1.elasticbeanstalk.com/running-shoes">Information</a>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <span id="loadingspan" class="new_page_disp1"><img src="http://new-env.ap-south-1.elasticbeanstalk.com/catalog/view/theme/lexus_nextstore/image/fb-loading.gif" alt="Loading"> </span>  
