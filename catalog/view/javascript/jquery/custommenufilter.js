   ...
   $.ajax({
    ...
    success: function(jsonresp){
     ...
     // var nimage=nimage.replace(' ','%20');  
      var proimage="http://new-env.ap-south-1.elasticbeanstalk.com/image/"+nimage;
     //var proimage="";
    ...
    $.ajax({
        type: "POST",
        url: 'http://new-env.ap-south-1.elasticbeanstalk.com/sendmail.php', 
        data: {
 ...
 function unsetorder()//continue order
 {
    ...
    $.ajax({
              ...
              success: function(resp){
                ...
                window.location.href='http://new-env.ap-south-1.elasticbeanstalk.com/new-arrivals'; 
                } 
                else
                {
                  $("#failure_msg1").show();
